        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('home') }}">SMKN 1 Kawali</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ (request()->segment(1) == 'kandidat') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('kandidat') }}">
                                <i class="fas fa-fire"></i><span>Data Calon</span>
                            </a>
                        </li>
                        <li class="{{ (request()->segment(1) == 'pemilih') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('pemilih') }}">
                                <i class="fas fa-user"></i><span>Data Peserta</span>
                            </a>
                        </li>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021 <div class="bullet"></div> Developed App By 
                    <a href="https://github.com/fikrisuheri">Fikri Suheri</a> And 
                    <a href="https://instagram.com/emilmaul_">Emil Maulana</a>
                </div>
