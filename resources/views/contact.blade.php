...
@section('container')
    ...
    <div class="container">
      <div class="row text-center align-items-center">
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0 text-secondary">46273 Dayeuhluhur. Jatinagara, Ciamis, Jawa Barat</p>
        </div>
        <div class="col-lg-4 py-3">
        ...
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0"><a href="#" class="text-secondary">halo@teknikrekayasa.com</a></p>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt-4">
      <div class="row justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0 card bg-white">
        ...
        <div class="col-lg-4 ml-4 card bg-light">
